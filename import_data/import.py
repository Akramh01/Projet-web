...
csv_file = '/Users/akramhamlat/Library/CloudStorage/OneDrive-Personnel/Etudes/L3/S2/Projet/Projet-web/Data/liste_personnel.csv'
...
for _, row in df.iterrows():
    cursor.execute("""
        INSERT INTO Employes (nom, prenom, date_embauche, idE, statut)
        VALUES (%s, %s, %s, %s, %s)
    """, (row['Nom'], row['Prenom'], row['date entrée entreprise'], row['identifiant'], row['Statut']))
